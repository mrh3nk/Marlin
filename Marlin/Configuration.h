...
#define STRING_CONFIG_H_AUTHOR "(Joost, Ender-3)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  13.5
    #define DEFAULT_Ki   0.98
    #define DEFAULT_Kd 46.28
  #endif
#endif // PIDTEMP
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 320, 320, 1600, 1650 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 38.2, 0, -0.4 }
